...
class SignInModal extends React.Component {
    ...
    signIn() {
        axios.post(`${process.env.REACT_APP_SERVER_URL}/signIn`,{email:this.state.email, password:this.state.password})
            .then((res) => {
            ...
            <div id='signInModal' className="modal">
                <div id='loginRegisterModalContent' className="modal-content">
                    ...
                    <view className='modal-real-content'>
                        ...
                        <button className='LoginButton' title='Login' onClick={this.signIn}>Login</button>
