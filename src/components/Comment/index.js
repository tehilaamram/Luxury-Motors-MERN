...
class Comment extends React.Component {
    ...
    dislikeChange() {
        console.log('in dislike change')
        if (this.props.dislike.includes(this.props.user.id)) {
        } else {
    ...
    render() {
        ...
        <div className="comment-dislike-num" >{this.props.dislike.length}</div>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 17" onClick={this.dislikeChange}>
