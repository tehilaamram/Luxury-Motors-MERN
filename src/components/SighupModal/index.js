...
class SignUpModal extends React.Component {
    constructor(props) {
        ...
        this.sighup = this.sighup.bind(this);
    ...
    sighup() {
        if(this.state.email===''||
            ...
            axios.post(`${process.env.REACT_APP_SERVER_URL}/user/putClient`, {
    ...
    render() {
        return (
            <div id='sighupRegisterModal' className="modal">
                <div id='loginRegisterModalContent' className="modal-content">
                    ...
                    <view className='modal-real-content'>
                        ...
                        <div style={{display: 'flex', justifyContent: 'space-between'}}><div style={{paddingTop: '12px', fontSize: '18px'}}>Confirm password </div><input onChange={this.onAgainPasswordChange} type='text'/></div>
                        ...
                        <button className='sighupButton' title='Login' onClick={this.sighup}>Sighup</button>
